                ...
                <div class="two">
                    <div class="three">
                        <div class="four">
                            ...
                            <div class="eight">
                            <a href="http://" target="_blank" rel="noopener noreferrer" class="a">
                                <button class="b">5 Designs to try at home!</button>
                            </a>
                        </div>
                    </div>
                    <div class="nine">
                        ...
                        <div class="eleven">
                            <div class="twelve">
                            <video className="video-c" autoPlay loop playsInline muted style={{width:"350px",height:"300px"}}>
                <source
                    src="https://banner.caratlane.com/live-images/4a56af38790c43f0a86cb04baef2853d.mp4" 
                    type="video/mp4"
                />
            </video>
